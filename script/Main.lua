...
maple.stopAtLevel = 30              -- Stop when reaching level 30 (0 = disabled)
...
maple.switchMapAfterMin = 10          -- Rotate to next map after X minutes of hunting
...
maple.buffList = {
    ...
    -- { id = 1101006, onRope = true },   -- Example: rage (needs rope)
}
...
maple.hpPotion = { id = 2000001, minNum = 50, threshold = 100, buy = 200 }  -- Use when HP < X
maple.mpPotion = { id = 2000003, minNum = 50, threshold = 50 , buy = 150 }  -- Use when MP < X
...
shop.shopMapId = 100000102              -- Map ID where the shop NPC is located
shop.shopLocation = { x = -281, y = 182 }    -- Coordinates to stand at to open shop
-- Selling configuration
shop.sellExcludeIds = {1462003,1452000}                -- Item IDs to never sell (e.g. {1302000, 1302001})
shop.equipSlotBuffer = 1                -- Trigger sell when empty equip slots <= this value
...
hunt.Attack.key = vk.VK_SHIFT        -- Single target attack
hunt.Attack.keyAoe = vk.VK_A     -- Multi target attack
...
hunt.mobIdFilter = {}               -- e.g. {100100, 100101} only attack these mob IDs
...
leveling.ap_per_level = {hp=0,mp=0,str=4,dex=1,int=0,luk=0}
leveling.jobs = {
