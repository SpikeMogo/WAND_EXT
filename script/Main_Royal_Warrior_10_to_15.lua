...
maple.huntMaps = {
        { id = 100020000, safeSpot = { x= 1084,  y= 65 } },
    }
...
shop.shopLocation = { x = -371, y = 224 }    -- Coordinates to stand at to open shop
-- Selling configuration
shop.sellExcludeIds = {}                -- Item IDs to never sell (e.g. {1302000, 1302001})
