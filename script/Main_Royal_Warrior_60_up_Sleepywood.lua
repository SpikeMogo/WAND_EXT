...
maple.stopAtLevel = 95              -- Stop when reaching level 30 (0 = disabled)
...
maple.huntMaps = {
        { id = 105040306, safeSpot = { x=93,  y= 1215 } },
...
shop.shopMapId = 105040401          -- Map ID where the shop NPC is located
shop.shopLocation = { x = 194, y =  206}    -- Coordinates to stand at to open shop
-- Selling configuration
shop.sellExcludeIds = {1402039,1432040,2044001,2040804,2030000,1040091}                -- Item IDs to never sell (e.g. {1302000, 1302001})
...
shop.additionalBuy = {{id = 2010004, targetCount = 1}}  --just for test
--------------------------------------------------------------------------------
-- hunt settings
--------------------------------------------------------------------------------
