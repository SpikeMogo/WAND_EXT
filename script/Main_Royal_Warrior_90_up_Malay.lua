...
maple.stopAtLevel = 120              -- Stop when reaching level 30 (0 = disabled)
...
maple.huntMaps = {
        { id = 551020000, safeSpot = { x=-1197, y= -80 } },
...
maple.hpPotion = { id = 2022207, minNum = 50, threshold = 4000,  buy = 1200 }  -- Use when HP < X
maple.mpPotion = { id = 2022208, minNum = 50, threshold = 100 ,  buy = 800 }  -- Use when MP < X
maple.petPotion = { id = 2120000, threshold = 50 }
maple.potionCooldownMs = 300
...
shop.shopMapId = 551000000          -- Map ID where the shop NPC is located
shop.shopLocation = { x = -992, y =  825}    -- Coordinates to stand at to open shop
-- Selling configuration
shop.sellExcludeIds = {2044001,2040804,2030000}                -- Item IDs to never sell (e.g. {1302000, 1302001})
...
shop.useReturnScrollId = 2030000
shop.additionalBuy = {}  --just for test
--------------------------------------------------------------------------------
-- hunt settings
--------------------------------------------------------------------------------
