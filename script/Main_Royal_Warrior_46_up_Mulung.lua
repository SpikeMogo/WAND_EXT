...
maple.huntMaps = {
        { id = 250020100, safeSpot = { x=-273, y= -98 } },
...
maple.buffList = {
    ...
    { id = 1101006, onRope = false },   -- Example: rage (needs rope)
}
...
shop.sellExcludeIds = {1302030,1060077}                -- Item IDs to never sell (e.g. {1302000, 1302001})
