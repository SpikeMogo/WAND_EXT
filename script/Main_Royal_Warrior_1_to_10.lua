...
maple.stopAtLevel = 10              -- Stop when reaching level 30 (0 = disabled)
...
--------------------------------------------------------------------------------
    ...
    -- Shop location
shop.enable = {buy = false, sell = false}
...
hunt.Attack.keyAoe = vk.VK_CONTROL     -- Multi target attack
...
hunt.mobIdFilter = {9999999}               -- e.g. {9999999} ignore attacking these mob IDs
hunt.platformFilter = {}            -- e.g. {0, 1, 2} ignore mobs on these platforms
